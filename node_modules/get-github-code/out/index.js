 ...
 */
var download = function (url, options) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, response, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, url_1.buildUrl(url, options)];
            case 1:
                url = _a.sent();
                return [4 /*yield*/, output_1.getFilename(url, options)];
            case 2:
                filename = _a.sent();
                _a.label = 3;
            case 3:
            ...
            case 5:
                err_1 = _a.sent();
                error_1.addErrMsg(err_1, 'could not download the source code.');
                throw err_1;
            case 6: return [4 /*yield*/, write_1.writeOutput(response.data, filename)];
            case 7:
                _a.sent();
                return [2 /*return*/];
        }
